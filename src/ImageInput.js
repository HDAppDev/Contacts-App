...
const resizeImage = (imageURL, canvas, maxHeight) => 
    ...
    // A custom <input> that dynamically reads and resize image file before
    // fubmitting them to the server as data URLs. Also, shows a preview of the image.
...
class ImageInput extends React.Component {
    ...
    componentWillUnmount() {
        this.fileInput.removeEventListener('reset', this.handleFormReset)
    }
